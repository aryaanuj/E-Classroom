...
if($_POST['user']!="" && $_POST['courses']!="")
{
    ...
    //fetching exam 
    $members_query2 = mysqli_query($con, "SELECT * FROM `visitor` ORDER BY date(startdate) DESC, duration DESC LIMIT 1" )or die(mysql_error());
    while($row2 = mysqli_fetch_array($members_query2)){
        $tdesc = $row2['test_content'];
    ...
    //fetch questions
    $query = "SELECT * FROM offering WHERE tests_c='$tdesc'";
    ...
    <head>
        ...
        <title>Triyambak Life Sciences</title>
                        ...
                        <div class="container">
                            <div class="navbar-header">
                                <a class="navbar-brand home">
                                    <table class="row">
                                      <tr>
                                        <td style="padding-right:10px;"><img src="img/tls_logo.png" alt="Triyambak logo" class="img-responsive" width="50px"></td>
                                        <td style="border-left:4px solid #f82249; padding-left:10px; margin-left:10px; "><h4>Triyambak Life Sciences</h4>
                                            <span style="font-size:14px;float: right;">Nurturing Life Science</span>
                                        </td>
                                    </tr>
                                </table>
                            </a>
                                            ...
                                            <div class="col-lg-12">
                                              ...
                                              while($row = mysqli_fetch_array($res))
                                              {
                                                ...
                                                <div style="display:none;" class="tab-content div-question mb0" id="page0<?php echo $counter; ?>">
                                                    <input type="hidden" class="subj" value="<?php echo $course; ?>">
                                                    <input type="hidden" class="stuid" value="<?php echo $sid; ?>">
                                                    <input type="hidden" class="examid" value="<?php echo $examid; ?>">
                                                    <input type="hidden" class="exam_desc" value="<?php echo $tdesc; ?>">
                                                    ...
                                                    <input type="hidden" value="<?php echo $row['questionanswer']; ?>" class="hdfCurrectAns">
                                                    <div class="question-height">
                                                        <h4 class="question-title"> Question <?php echo $counter; ?>:  </h4>
                                                        <span><?php echo $row['questiondesc']; ?></span> 
                                                        <?php if($row['qimage']!=""){?>
                                                        <!-- question Image -->
                                                        <span><img src="images/questionImages/<?php echo $row['qimage']; ?>" class=" img-thumbnail" style="max-width:500px; max-height:400px; min-width:100px; min-height:100px;"> </span><br>
                                                        <?php }?>
                                                        <table class="table table-borderless mb0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td> 
                                                                        <!-- option A -->
                                                                        <input type="radio" value="<?php echo $row['valueoptions'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1">1 )
                                                                        <?php if(substr($row['valueoptions'], 0, 3) == "img"){ ?>
                                                                        <img src="images/questionImages/<?php echo substr($row['valueoptions'],3, strlen($row['valueoptions']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                        <?php  }else{ 
                                                                           echo $row['valueoptions'];
                                                                       }
                                                                       ?>

                                                                   </td>
                                                                   <!-- option B -->
                                                                   <td> <input type="radio" value="<?php echo $row['valueoptionsb'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 2 )<?php if(substr($row['valueoptionsb'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['valueoptionsb'],3, strlen($row['valueoptionsb']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['valueoptionsb'];
                                                                   }
                                                                   ?></td>
                                                                   <!-- option c -->
                                                                   <td> <input type="radio" value="<?php echo $row['valueoptionsc'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 3 )<?php if(substr($row['valueoptionsc'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['valueoptionsc'],3, strlen($row['valueoptionsc']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['valueoptionsc'];
                                                                   }
                                                                   ?> </td>
                                                                   <!-- option d -->
                                                                   <td> <input type="radio" value="<?php echo $row['valueoptionsd'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 4 )<?php if(substr($row['valueoptionsd'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['valueoptionsd'],3, strlen($row['valueoptionsc']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['valueoptionsd'];
                                                                   }
                                                                   ?> </td>
                                                               </tr>
                                                           </tbody>
                                ...
                                <div class="panel panel-default" style="border:1px solid black;">
                                    <div class="panel-body " style="height:320px;overflow-y:auto;">
                                        <ul class="pagination test-questions">
                                            <?php $count=0;
                                            $sql = "SELECT * FROM offering WHERE tests_c='$tdesc'";
