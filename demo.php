                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td> 
                                                                        ...
                                                                        <?php if(substr($row['option2'], 0, 3) == "img"){ ?>
                                                                        <img src="images/questionImages/<?php echo substr($row['option1'],3, strlen($row['option1']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                        <?php  }else{ 
                                                                           echo $row['option1'];
                                                                       }
                                                                       ?>
                                                                   ...
                                                                   <!-- option B -->
                                                                   <td> <input type="radio" value="<?php echo $row['option2'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 2 )<?php if(substr($row['option2'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['option2'],3, strlen($row['option2']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['option2'];
                                                                   }
                                                                   ?></td>
                                                                   <!-- option c -->
                                                                   <td> <input type="radio" value="<?php echo $row['option3'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 3 )<?php if(substr($row['option3'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['option3'],3, strlen($row['option3']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['option3'];
                                                                   }
                                                                   ?> </td>
                                                                   <!-- option d -->
                                                                   <td> <input type="radio" value="<?php echo $row['option4'] ?>" name="radiospage0<?php echo $counter; ?>" id="rOption<?php echo $counter; ?>_1"> 4 )<?php if(substr($row['option4'], 0, 3) == "img"){ ?>
                                                                      <img src="images/questionImages/<?php echo substr($row['option4'],3, strlen($row['option3']))?>" class="img-thumbnail" style="max-width:100%; max-height:150px; min-width:100px; min-height:100px;">
                                                                      <?php  }else{ 
                                                                       echo $row['option4'];
                                                                   }
                                                                   ?> </td>
